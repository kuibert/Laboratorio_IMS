...
function mostrarEstudiantes() {
    ...
    if (estudiantes.length > 0) {
        for (let i = 0; i < estudiantes.length; i++) {
            ...
            data.append("<input type='hidden' name='grupo_estudiantes[" + i +
                "][idgrupo]' value='" + estudiantes[i].idgrupo + "'/>");
            data.append("<input type='hidden' name='grupo_estudiantes[" + i +
                "][idestudiante]' value='" + estudiantes[i].idestudiante + "'/>");
        }
    } else {
    ...
    data.append("<input type='hidden' name='idgrupo' value='" +
        $("#idgrupo").val() + "'/>")
